...
altText b =
    case b of
        ...
        SubmitTagValue -> "[Submit Value]"
        SubmitValueForRestoredTag -> "[Restore Tag With Given Value]"
...
textInput = "border-slate-300 border-solid border-2 rounded-r-md mr-3"
...
inputLabel = "text-gray-900 font-semibold py-2 mr-2"


errorsList = ""


errorItem = "border-red-400 rounded-sm"
...
itemWithEditableValue = "py-2"


selectBox = "text-blue-600 border-3 border-indigo font-semibold mr-2"


selectOption = "font-semibold"
...
readOnlyValuesList = "list-none"


inputsForValuesList = "list-none"


fieldLabel = "text-gray-900 font-semibold py-2 mr-2"


fieldValue = "text-blue-700 mr-3"
...
editingTagItem = "list-none"


archivedTagItem = "list-none"


tagName = "text-blue-600 bg-slate-200 px-1.5 py-1 rounded-l-md rounded-r-none"


archivedTagName = "text-teal-600 bg-slate-100 px-1.5 py-1 rounded-l-md rounded-r-md mr-3"


tagValue = "text-white bg-slate-500 px-1.5 py-1 rounded-l-none rounded-r-md mr-3"